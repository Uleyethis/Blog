...
export default function ArticlesIndex({ articles }) {
  return (
    <>
      <Head>
        <title>Articles - Uley</title>
        <meta
          name="description"
          content="All of my long-form thoughts on programming, game design, learning unity/unreal, and more, collected in chronological order."
        />
      </Head>
      <SimpleLayout
