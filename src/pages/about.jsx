...
export default function About() {
  return (
    <>
      <Head>
        <title>About - Uley</title>
        <meta
          name="description"
          content="I’m Uley. I live in Northern Ontario, I am learning how to make games."
        />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              I’m Uley. I live in Northern Ontario, I am learning how to make
              games.
            </h1>
            <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
              ...
              <p>
                ...
                in BASIC in highschool, moving onto .NET in college. I am constantly looking
          ...
          <div className="lg:pl-20">
            <ul role="list">
              <SocialLink href="https://www.twitter.com/DerciFrog" icon={TwitterIcon}>
                Follow on Twitter
              </SocialLink>
              <SocialLink href="https://www.github.com/Uleyethis" icon={GitHubIcon} className="mt-4">
                Follow on GitHub
               </SocialLink>
              {/*<SocialLink
